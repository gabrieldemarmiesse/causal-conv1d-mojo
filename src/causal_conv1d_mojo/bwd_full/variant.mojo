...
comptime N_ELTS: Int = get_defined_int["N_ELTS"]()
...
comptime CONTIG_INNER: Bool = get_defined_bool["CONTIG_INNER"]()
comptime ALIGNED_SEQ: Bool = get_defined_bool["ALIGNED_SEQ"]()
...
def causal_conv1d_bwd_full_variant(
    ...
    var x_b_stride: UInt32 = UInt32(py=args[10])
    var x_c_stride: UInt32 = UInt32(py=args[11])
    var x_l_stride: UInt32 = UInt32(py=args[12])
    var w_c_stride: UInt32 = UInt32(py=args[13])
    var w_w_stride: UInt32 = UInt32(py=args[14])
    var dout_b_stride: UInt32 = UInt32(py=args[15])
    var dout_c_stride: UInt32 = UInt32(py=args[16])
    var dout_l_stride: UInt32 = UInt32(py=args[17])
    var dx_b_stride: UInt32 = UInt32(py=args[18])
    var dx_c_stride: UInt32 = UInt32(py=args[19])
    var dx_l_stride: UInt32 = UInt32(py=args[20])
    var stream_handle_addr: Int = Int(py=args[24])
    var seq_idx_addr: Int = Int(py=args[27])
    var seq_idx_b_stride: UInt32 = UInt32(py=args[28])
    var seq_idx_l_stride: UInt32 = UInt32(py=args[29])
    var initial_states_addr: Int = Int(py=args[31])
    var initial_states_b_stride: UInt32 = UInt32(py=args[32])
    var initial_states_c_stride: UInt32 = UInt32(py=args[33])
    var initial_states_l_stride: UInt32 = UInt32(py=args[34])
    var dinitial_states_addr: Int = Int(py=args[35])
    var dinitial_states_b_stride: UInt32 = UInt32(py=args[36])
    var dinitial_states_c_stride: UInt32 = UInt32(py=args[37])
    var dinitial_states_l_stride: UInt32 = UInt32(py=args[38])
