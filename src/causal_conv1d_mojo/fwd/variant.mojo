...
comptime VEC_ALIGNED: Bool = get_defined_bool["VEC_ALIGNED"]()
...
def causal_conv1d_fwd_variant(
    ...
    var seq_idx_b_stride: UInt32 = UInt32(py=args[21])
    var seq_idx_l_stride: UInt32 = UInt32(py=args[22])
    var initial_states_addr: Int = Int(py=args[25])
    var initial_states_b_stride: UInt32 = UInt32(py=args[26])
    var initial_states_c_stride: UInt32 = UInt32(py=args[27])
    var initial_states_l_stride: UInt32 = UInt32(py=args[28])
