...
def causal_conv1d_update_variant(
    ...
    var x_b_stride: Int32 = Int32(py=args[9])
    var x_c_stride: Int32 = Int32(py=args[10])
    var x_l_stride: Int32 = Int32(py=args[11])
    var w_c_stride: Int32 = Int32(py=args[12])
    var w_w_stride: Int32 = Int32(py=args[13])
    var state_b_stride: Int32 = Int32(py=args[14])
    var state_c_stride: Int32 = Int32(py=args[15])
    var state_l_stride: Int32 = Int32(py=args[16])
    var o_b_stride: Int32 = Int32(py=args[17])
    var o_c_stride: Int32 = Int32(py=args[18])
    var o_l_stride: Int32 = Int32(py=args[19])
