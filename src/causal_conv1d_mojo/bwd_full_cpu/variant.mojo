...
def causal_conv1d_bwd_full_cpu_variant(
    ...
    var seq_idx_b_stride: UInt32 = UInt32(py=args[22])
    var seq_idx_l_stride: UInt32 = UInt32(py=args[23])
    var initial_states_addr: Int = Int(py=args[24])
    var initial_states_b_stride: UInt32 = UInt32(py=args[25])
    var initial_states_c_stride: UInt32 = UInt32(py=args[26])
    var initial_states_l_stride: UInt32 = UInt32(py=args[27])
    var dinitial_states_addr: Int = Int(py=args[28])
    var dinitial_states_b_stride: UInt32 = UInt32(py=args[29])
    var dinitial_states_c_stride: UInt32 = UInt32(py=args[30])
    var dinitial_states_l_stride: UInt32 = UInt32(py=args[31])
